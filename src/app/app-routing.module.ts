...
//   { path: '', redirectTo: '/login', pathMatch: 'full' },
  ...
  { 
    ...
    children : [
      ...
      {path:'cloture', component: AffectationsClotureComponent},
      {path:'details', component: AffectationsDetailsComponent},
      {path:'creation', component: AffectationsFormComponent},
      {path:'suppression', component: AffectationsSuppressionComponent},
